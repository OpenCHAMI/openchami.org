...
in a file and be applied with a command.
...
1. At least one of:
   ...
   1. URI to initrd file
   1. Kernel command line arguments

   ***OR:***

   1. A file containing the boot parameter data (this method will be used here)
...
**/etc/openchami/data/boot/boot-compute-debug-rocky9.yaml**, that contains the
